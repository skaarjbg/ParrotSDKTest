package co.flyver.parrotsdktest.devicecontroller.config;
...
public final class ARDroneNetworkConfig extends ARNetworkConfig {
    private static final String TAG = ARDroneNetworkConfig.class.getSimpleName();
